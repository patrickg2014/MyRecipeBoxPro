...
/**
 * This class allows the user to send a desired recipe by text messaging
 * @author Patrick
 *
 */
public class TextSender extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//
		setListAdapter(new ArrayAdapter<String>(TextSender.this, android.R.layout.simple_list_item_1, titles));
		//setting background
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent viewRecipe = new Intent("com.smarttechnow.patrick.TEXTSUBMIT");
